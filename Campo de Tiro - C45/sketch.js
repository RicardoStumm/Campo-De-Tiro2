...
function Win() {
    ...
    swal({
        ...
        //Observação: retirei o botão de confirmação do Swal para criar um abaixo
...
function gameOver() {
    ...
    swal({
        title: `Você perdeu, tente novamente`,
        ...
        imageUrl:
          "https://th.bing.com/th/id/OIP.AlNmhSVjMuaNaohXihiKlQHaHa?pid=ImgDet&rs=1",
        imageSize: "400x400",
        ...
        resetButton2 = createButton("");
        resetButton2.class("resetButton");
        resetButton2.position(width/2 - 35, height/2 + 214);

        if (resetButton2.mousePressed(() => {
            window.location.reload();
            })
        );
}